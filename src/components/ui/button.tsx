  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-glow hover:shadow-elevated transform hover:scale-105 font-semibold",
        success: "bg-gradient-success text-secondary-foreground shadow-md hover:shadow-lg transform hover:scale-105",
        warning: "bg-gradient-warning text-accent-foreground shadow-md hover:shadow-lg transform hover:scale-105",
